#ifndef __AwkZmAf0cF6Onhxj0pC4hF_h__
#define __AwkZmAf0cF6Onhxj0pC4hF_h__
...
using sGaAmWJmK5HvPUvd2k3PkCG = tag_sGaAmWJmK5HvPUvd2k3PkCG;
...
using sc6f4Behc0Ffg9eeZ0XliHC = tag_sc6f4Behc0Ffg9eeZ0XliHC;
...
using rtString_2 = tag_IXZbk4aPjQFR6fO0q1hmvH;
...
using cell_wrap = tag_BlgwLpgj2bjudmbmVKWwDE;
...
using comm_internal_AWGNChannel = tag_TCJulQaTv5GQfo6OSDGDKF;
...
using smzGQHcQ1fZcSCW5rtLpn4F = tag_smzGQHcQ1fZcSCW5rtLpn4F;
...
using b_cell_wrap = tag_Mq55LRTpx3F49SLl4MgJ3G;
...
using cell = tag_C79ocpswzft4rqJBIhLBlC;
...
using b_cell = tag_ueapjuTygbhlYTyuwuM18F;
...
using c_cell = tag_IWHquoku2Gpg6ovlO02R9F;
...
using d_cell = tag_xR7dlhZdUObjGfdDSjt5XE;
...
using e_cell = tag_Hm6EPE5ncyWd4RGCxxctzF;
...
using f_cell = tag_n5V6NPhGd1s3l2q7z9eOR;
...
using g_cell = tag_VqK0uXiUXuliBvHmvcLR0F;
...
using h_cell = tag_njgfiHhWBCqqqpWsKZxr7F;
...
using i_cell = tag_fBlGzRSC7MIhHBr5b4VWCG;
...
using f_cell_wrap = tag_QUrJGLT4DsCLhnuPIs5e8F;
...
using j_cell = tag_KzvDXcILqv8HZzd4pSVRPG;
...
using k_cell = tag_xOZlLoGvSrTJr14RWwCqHG;
...
using s_f0FJd1n2NNMv9YVafSuVeE = tag_f0FJd1n2NNMv9YVafSuVeE;
...
using l_cell = tag_n3SDPft8LycMqfcEsfJVBB;
...
using s_KzDXXxjSf4pssDuUTLtuSD = tag_KzDXXxjSf4pssDuUTLtuSD;
...
using s_dUAff3Yz8NM29ckwbq6CH = tag_dUAff3Yz8NM29ckwbq6CH;
...
using s_7k8G96RLvhrsuJdtYxQJWF = tag_7k8G96RLvhrsuJdtYxQJWF;
...
using s_UF0dQR13DRlcTN77hznBXH = tag_UF0dQR13DRlcTN77hznBXH;
...
using s_vvSqV1w1prqiKtQKYggdIG = tag_vvSqV1w1prqiKtQKYggdIG;
...
using s_uzuPWHtc1cM7ZRTfbsKeiF = tag_uzuPWHtc1cM7ZRTfbsKeiF;
...
using s_SODWYhUBKKfkB1yckYIVoG = tag_SODWYhUBKKfkB1yckYIVoG;
...
using s_rs0J7tUaO8r8RV5HCYwLTD = tag_rs0J7tUaO8r8RV5HCYwLTD;
...
using s_VIdiz3pTcOXEgZ6SQ4xHD = tag_VIdiz3pTcOXEgZ6SQ4xHD;
...
using s_JkNjgv3CFjBZhduPupEzEE = tag_JkNjgv3CFjBZhduPupEzEE;
...
using s_wvzWMLKjXp7EJVnnMvwbTC = tag_wvzWMLKjXp7EJVnnMvwbTC;

#endif                                 /* typedef_s_wvzWMLKjXp7EJVnnMvwbTC */

#ifndef typedef_InstanceStruct_AwkZmAf0cF6Onhxj0pC4hF
#define typedef_InstanceStruct_AwkZmAf0cF6Onhxj0pC4hF

struct InstanceStruct_AwkZmAf0cF6Onhxj0pC4hF
{
  SimStruct *S;
...
#endif                                 /* typedef_InstanceStruct_AwkZmAf0cF6Onhxj0pC4hF */
...
extern void method_dispatcher_AwkZmAf0cF6Onhxj0pC4hF(SimStruct *S, int_T method,
  void* data);
